...
const MENU_DATA = [
  ...
  { id: '5', title: 'News and Announcements', icon: 'newspaper-outline', color: '#FFA500', route: '/news' },
  { id: '6', title: 'School Statistics', icon: 'stats-chart-outline', color: '#8B0000', route: '/statistics' },
  { id: '7', title: 'Campus Tour', icon: 'camera-outline', color: '#6C63FF', route: '/virtualtour' }
];
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, async (querySnapshot) => {
      ...
      // Animate notification container when new notifications appear
      ...
      <Animated.View style={[styles.gradientOverlay, { backgroundColor: 'rgba(13, 62, 134, 0.45)', opacity: fadeAnim }]}>
        ...
        <Animated.View style={{ 
          ...
          <View style={styles.brandCard}>
            <Image source={require('../assets/images/logo3.png')} style={styles.brandLogo} />
            <View>
